              ...
              <form onSubmit={handleSaveForm} className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                {type === 'siswa' && (
                  <>
                    ...
                    <div><label className="block text-sm font-medium mb-1 dark:text-slate-300">NISN</label><input name="nisn" defaultValue={data?.nisn || ''} required className="w-full rounded-md border p-2 dark:bg-slate-700 dark:border-slate-600 dark:text-white" /></div>
