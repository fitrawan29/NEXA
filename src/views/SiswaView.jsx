                ...
                {dataRiwayat.length === 0 ? (
                  ...
                  dataRiwayat.map(r => (
                    <div key={r.id_log} onClick={() => setDetailNilaiModal(r)} className="bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-700 flex justify-between items-center cursor-pointer hover:border-primary/50 hover:shadow-md transition-all group">
                       ...
                       <div className={`bg-gradient-to-br ${r.is_blocked ? 'from-error to-error text-white' : 'from-green-400 to-green-600 text-white'} font-black w-14 h-14 rounded-2xl flex items-center justify-center text-xl ${!r.is_blocked && 'shadow-[0_5px_15px_rgba(74,222,128,0.3)]'} shrink-0`}>
              ...
              <div className="bg-white dark:bg-slate-800 w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl relative z-10 shadow-2xl animate-slide-up overflow-hidden border border-slate-100 dark:border-slate-700">
                 ...
                 <div className="p-6">
                    <div className="flex flex-col items-center justify-center mb-8 relative">
                       <div className={`w-32 h-32 rounded-full border-8 border-slate-50 dark:border-slate-900 flex items-center justify-center bg-gradient-to-br ${detailNilaiModal.is_blocked ? 'from-error to-error' : 'from-green-400 to-green-600'} shadow-xl z-10 text-white relative -mt-16`}>
